...
QtObject {
    ...
    readonly property color panelHeader: '#e2e8f0'  // 面板标题背景
    readonly property color windowBg: "#f1f5f9"     // 窗口底色
    readonly property color rowSelected: "#e8f1ff"  // 选中行

    // —— 线条 / 边框 ——
    readonly property color resizeHandle: "#e2e8f0" // 调整手柄
    readonly property color border: "#f1f5f9"       // 面板/单元边框
    ...
    readonly property color accentSoft: "#ff0000"   // 弱强调填充
